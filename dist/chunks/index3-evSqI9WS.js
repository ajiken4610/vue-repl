import { a as getAugmentedNamespace, c as commonjsGlobal } from './_commonjsHelpers-9Q-OoQuc.js';
import { l as lib } from './MonacoEditor-5pQkxUfB.js';
import 'vue';
...
async function dispatchGrammars(scopeName) {
  switch (scopeName) {
    case "source.vue":
      return {
        format: "json",
        content: await import('./vue.tmLanguage-Kr_zPmBa.js')
      };
    case "source.ts":
      return {
        format: "json",
        content: await import('./TypeScript.tmLanguage-_NQwMFax.js')
      };
    case "source.js":
      return {
        format: "json",
        content: await import('./JavaScript.tmLanguage-G00wHuuU.js')
      };
    case "text.html.basic":
      return {
        format: "json",
        content: await import('./html.tmLanguage-oTCPp0OK.js')
      };
    case "source.css":
      return {
        format: "json",
        content: await import('./css.tmLanguage-v2BEZnO6.js')
      };
    default:
      return {
        format: "json",
