...
import { defineComponent, ref, inject, onMounted, watchEffect, openBlock, createElementBlock, computed, createBlock } from 'vue';
import { d as debounce } from './chunks/utils-obz1_5fQ.js';
...
(function (module, exports) {
	...
	(function(mod) {
	  mod(requireCodemirror(), requireXmlFold());
	})(function(CodeMirror) {
...
(function (module, exports) {
	...
	(function(mod) {
	  mod(requireCodemirror(), requireSearchcursor(), requireDialog());
	})(function(CodeMirror) {
